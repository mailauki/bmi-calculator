    ...
    <div className="p-4 w-fit rounded-full shadow-[20px_20px_60px_#c4c3c2,-20px_-20px_60px_#ffffff] dark:shadow-[20px_20px_60px_#231f1f,-20px_-20px_60px_#2f2b29]">
      <div className="relative size-52">
        <svg className="size-full -rotate-90" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Progress Circle */}
          <circle className="stroke-current text-blue-500 dark:text-blue-400" cx="18" cy="18" fill="none" r="16" strokeDasharray="100" strokeDashoffset="65" strokeLinecap="round" strokeWidth="2" />
        </svg>
